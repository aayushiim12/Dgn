        ...
        <div class="container flex justify-center">
            <div class="row ">
                ...
                <div class="single-widget ">
                       <h2 class="footer-title">Important Links</h2>
                         <ul>
                            <li><a href="entrance-automation.php">Entrance Automation</a></li>
                            <li><a href="hygiene-automation.php">Hygiene Automation</a></li>
                            <li><a href="door-automation.php">Door Automation</a></li>
                         </ul>
                        </div>
                     </div>
            ...
            <div class="single-widget newsletter">
                        ...
                        <ul class="list">
                            ...
                            <li><i class="far fa-envelope"></i> M-9, Basement, </li>
                ...
                <div class="col-12">
                    <div class="bottom-head">
                        <div class="row">
                            <div class="col-12">
                                <div class="copyright">
                                    <p>© Copyright 2021 <a href="http://dhingragroup.in/"> Dhingra Group. </a> All Rights Reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
