                                ...
                                <div class="tab-content" id="myTabContent3">
                                    <div class="tabs">
                                        <ul class="nav nav-tabs nav-tabs-links d-flex justify-content-center" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#btn0" role="tab" aria-controls="home" aria-selected="true"> <button type="button" class="btn  btn-roundeded"> Hand Dryers</button></a>
                                            </li>
                                 
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#btn1" role="tab" aria-controls="profile" aria-selected="false">  <button type="button" class="btn btn-roundeded">Automatic Taps</button></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#btn2" role="tab" aria-controls="profile" aria-selected="false">  <button type="button" class="btn  btn-roundeded">Dispensers and sanitizers</button></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#btn3" role="tab" aria-controls="contact" aria-selected="false"><button type="button" class="btn btn-roundeded">Urinal & WC sensors</button></a>
                                            </li>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="btn0" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="row team-members team-members-left team-members-shadow m-b-40  animated visible lightSpeedIn" data-animate="lightSpeedIn">
                                                    <div class="section-title text-center py-4 pb-5 ">
                                                        <h2 class="elementor-heading-title elementor-size-default ">Hand Dryers</h2>
                                                       </div>
                                                    <div class="col-lg-6 col-12 cover animated visible pulse" data-animate="pulse">
                                                    ...
                                                    <div class="col-lg-6  cover animated visible pulse" data-animate="pulse" >
                                                        <div class="team-member">
                                                            <div class="team-image">
                                            ...
                                            <div class="tab-pane fade" id="btn1" role="tabpanel" aria-labelledby="profile-tab">
                                                <div class="row team-members team-members-left team-members-shadow m-b-40">
                                                    <div class="section-title text-center py-4">
                                                        <h2 class="elementor-heading-title elementor-size-default">Automatic Taps</h2>
                                                       </div>
                                                    <div class="col-lg-6 cover animated visible pulse" data-animate="pulse">
                                                        <div class="team-member">
                                                            <div class="team-image">
                                            ...
                                            <div class="tab-pane fade" id="btn2" role="tabpanel" aria-labelledby="profile-tab">
                                                <div class="row team-members team-members-left team-members-shadow m-b-40">
                                                    <div class="section-title text-center py-4 pb-5">
                                                        <h2 class="elementor-heading-title elementor-size-default">Dispensers and sanitizers</h2>
                                                       </div>
                                                    <div class="col-lg-6 cover animated visible pulse" data-animate="pulse">
                                                        <div class="team-member">
                                                            <div class="team-image">
                                            ...
                                            <div class="tab-pane fade" id="btn3" role="tabpanel" aria-labelledby="contact-tab">
                                                <div class="row team-members team-members-left team-members-shadow m-b-40">
                                                    <div class="section-title text-center py-4 pb-5">
                                                        <h2 class="elementor-heading-title elementor-size-default">Urinal & WC sensors</h2>
                                                       </div>
                                                    <div class="col-lg-6 cover animated visible pulse" data-animate="pulse" ">
                                                        <div class="team-member">
                                                            <div class="team-image">
